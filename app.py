...
<div class="layout">
    <aside class="sidebar">
        ...
        <div class="styles-wrap">
            ...
            <div class="style-chip" data-style="photorealistic, ultra detailed, 8k photography"><span class="chip-dot"></span> Realiste</div>
            <div class="style-chip" data-style="anime style, manga illustration, vibrant colors"><span class="chip-dot"></span> Anime</div>
            <div class="style-chip" data-style="oil painting, artistic brushstrokes, museum quality"><span class="chip-dot"></span> Peinture</div>
            <div class="style-chip" data-style="pixel art, 16-bit retro game style"><span class="chip-dot"></span> Pixel Art</div>
            <div class="style-chip" data-style="cyberpunk, neon lights, futuristic dark city"><span class="chip-dot"></span> Cyberpunk</div>
            <div class="style-chip" data-style="watercolor painting, soft dreamy illustration"><span class="chip-dot"></span> Aquarelle</div>
            <div class="style-chip" data-style="dark fantasy, dramatic lighting, epic scene"><span class="chip-dot"></span> Dark Fantasy</div>
            <div class="style-chip" data-style="minimalist design, clean geometric shapes"><span class="chip-dot"></span> Minimaliste</div>
            <div class="style-chip" data-style="3d render, octane render, volumetric lighting"><span class="chip-dot"></span> 3D Render</div>
            <div class="style-chip" data-style="vintage photograph, film grain, 1970s color"><span class="chip-dot"></span> Vintage</div>
            <div class="style-chip" data-style="comic book style, bold outlines, halftone dots"><span class="chip-dot"></span> Comics</div>
        </div>
        <div class="user-wrap">
    ...
    <main class="main">
        <div class="page active" id="page-chat">
            <div class="chat-scroll" id="chatScroll">
                <div class="welcome" id="welcomeMsg">
                    ...
                    <p>Decris ton idee, je vais te poser quelques questions pour affiner ta vision.</p>
        ...
        <div class="page" id="page-gallery">
            <div class="page-hdr">
                <div><h2>Galerie</h2><p>Tes creations par projet</p></div>
...
var inspirePool = [
    "Un astronaute solitaire explorant une planete alien",
    "Une bibliotheque magique flottant dans les nuages",
    "Un dragon de cristal dans une foret lumineuse",
    "Une ville sous-marine futuriste bioluminescente",
    "Un titan mecanique gardant des ruines anciennes",
    "Une foret de champignons geants sous une lune violette",
    "Un robot peintre dans un desert de sel",
    "Un samurai fantome dans une foret de cerisiers",
    "Un marche de magie nocturne medieval",
    "Un cafe dans une station spatiale"
];
...
window.addEventListener("load", function() {
    ...
    document.getElementById("lightbox").addEventListener("click", function() { document.getElementById("lightbox").classList.remove("open"); });
...
function renderHistory() {
    ...
    list.innerHTML = "";
    if (!hist.length) {
        list.innerHTML = "<div class='empty'><div class='empty-i'>&#8635;</div><p>Aucun prompt encore.</p></div>";
        return;
    }
...
function loadGallery() {
    if (!currentUser) {
        document.getElementById("foldersList").innerHTML = "<div class='empty' style='width:100%'><div class='empty-i'>&#128274;</div><p>Connecte-toi pour acceder a ta galerie</p></div>";
...
function renderGallery(data) {
    ...
    if (!keys.length) {
        fList.innerHTML = "<div class='empty' style='width:100%'><div class='empty-i'>&#8862;</div><p>Aucun dossier. Cree ton premier projet !</p></div>";
        return;
    }
...
Compte le nombre de messages de l utilisateur :
- 1er message : pose UNE question sur le style visuel (realiste, anime, peinture, cyberpunk...)
- 2eme message : pose UNE question sur l ambiance ou les details
- 3eme message : demande combien d images souhaitez-vous entre 1 et 5
- 4eme message ou plus : genere OBLIGATOIREMENT avec ce format exact :
GENERATE: [prompt anglais tres detaille]
COUNT: [1-5]
MESSAGE: [message court en francais]
...
def generate():
    ...
    print("Reponse:", response.text[:300])
